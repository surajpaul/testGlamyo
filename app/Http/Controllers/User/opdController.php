...
class opdController extends Controller
{
    ...
    {
        $myId = Auth::id();
        $opds = opd::latest()->where('user_id', $myId)->paginate(10);
        return view('user.opd.index', compact('opds'));
    }
    ...
    public function create()
    {
        ...
        return view('user.opd.create', compact('doctors','hospitals','treatments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/user/opd')->with('success', 'OPD is booked successfully.');
    }
    ...
    public function show($id)
    {
        ...
        return view('user.opd.show', compact('opd', 'hospital'));
    }
    ...
    public function edit($id)
    {
        ...
        $hospitals = User::latest()->where('role_id', 3)->get();
        $treatments = Treatment::latest()->get();
        return view('user.opd.edit', compact('opd', 'doctors', 'hospitals', 'treatments'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/user/opd')->with('success', 'OPD has been successfully updated.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/user/opd')->with('success', 'OPD is successfully deleted.');
    }
    ...
    public function active(Request $request, $id)
    {
        ...
        return redirect('/user/opd')->with('success', 'OPD status is successfully updated.');
    }
