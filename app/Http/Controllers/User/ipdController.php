...
class ipdController extends Controller
{
    ...
    {
        $myId = Auth::id();
        $ipds = ipd::latest()->where('user_id', $myId)->paginate(10);
        return view('user.ipd.index', compact('ipds'));
    }
    ...
    public function create()
    {
        ...
        return view('user.ipd.create', compact('doctors','hospitals','rooms','treatments', 'payments'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'test' => 'nullable',
            'attendant' => 'required',
            'aadhar.*' => 'required|file|mimes:jpg,png,jpeg|max:204800',
            'payment_id' => 'required|integer',
            'admission_amt' => 'nullable',
            'discharge_amt'=> 'nullable',
            'insurance.*'=> 'nullable|file|mimes:jpg,png,jpeg|max:204800',
            'billed_amt'=> 'nullable',
        ...
        return redirect('/user/ipd')->with('success', 'IPD is booked successfully.');
    }
    ...
    public function show($id)
    {
        ...
        return view('user.ipd.show', compact('ipd', 'hospital'));
    }
    ...
    public function edit($id)
    {
        ...
        $treatments = Treatment::latest()->get();
        $payments = Payment::latest()->get();
        return view('user.ipd.edit', compact('ipd', 'doctors', 'hospitals', 'rooms' , 'treatments', 'payments'));
    }
    ...
    {
        $aadhar_name = $request->aadhar_hide_user;
        $aadhar = $request->file('aadhar');
        if($aadhar != ''){
            $aadhar_name = rand() . '.' . $aadhar->getClientOriginalExtension();
            $aadhar->move(public_path('aadhar'), $aadhar_name);
        ...
        $insurance_name = $request->insurance_hide_user;
        $insurance = $request->file('insurance');
        if($insurance != ''){
            $insurance_name = rand() . '.' . $insurance->getClientOriginalExtension();
            $insurance->move(public_path('insurance'), $insurance_name);
        ...
        return redirect('/user/ipd')->with('success', 'IPD has been successfully updated.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/user/ipd')->with('success', 'IPD is successfully deleted.');
    }
    ...
    public function active(Request $request, $id)
    {
        ...
        return redirect('/user/ipd')->with('success', 'IPD status is successfully updated.');
    }
