...
@section('title')
<title>Painless Fissure Laser Treatment | Glamyo Health</title>
@endsection
...
<div id="home">
      <div class="row mt-100">
        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
          <div class="main-title">
            <h2 class="product-title">Painless Fissure Laser Treatment</h2>
              <p>
              At Glamyo Health, our expert doctors will take care of fissure in a painless one day laser procedure.
              </p>
   ...
   <!-- Info and symptoms starts -->  
    <div id="reviews" style="padding-bottom: 100px">
            ...
            <div class="text-left">
                 <h2 style="color: #0F74B2; font-weight: 600;">Fissure </h2>
                </div>
                <div class="testimonials-white">
                        ...
                        <div class="text-left">
                            <div class="quote2">
                                <div>
                               <p style="margin-top: 10px; margin-bottom: 40px;">An anal fissure is a small tear in the thin, moist tissue (mucosa) that lines the anus. It can cause pain and bleeding during bowel movements. You also may experience spasms in the ring of muscle at the end of your anus (anal sphincter).
Anal fissures are very common in young infants but can affect people of any age. Medication may temporarily relieve you from the pain whereas surgery may be required for curing the root of the disease.</p>
                ...
                <span class="author" style="color: #0F74B2; font-weight: 600;">Symptoms of Fissure</span>
                   
                        <div class="service-content">
                        <ul class="symptoms-list">
                        <li>Blood while passing stools</li>
                                        <li> Pain during or even after bowel movements</li>
                                            <li>A visible crack in the skin around the anus</li>
                                                <li>A small lump or skin tag on the skin near the anal region</li>
                                               
                           </ul></div>
                           <div class="service-content mt-40">
                           <span class="author" style="color: #0F74B2; font-weight: 600;">Causes of Fissure</span>
                           <ul class="symptoms-list">
                                            <li>Passing large or hard stools
                                            </li>
                                            <li>Constipation and straining during bowel movements
                                            </li>
              ...
              <div class="row">
                  <div class="col-md-6 col-lg-6">
                      <h4>Worried about price?  </h4>
                        <p>Glamyo has made the latest, laser treatment for Fissure affordable and accessible to all.</p> 
                        <div class="quote2">
                          <div>
                  ...
                  <div class="col-lg-6 col-md-6 show-desktop hide-mobile">
                    ...
                    <div class="row">
                    <div class="col-md-6 col-lg-6">
                          <a onclick="return gtag_report_conversion('tel:9711144230')" href="tel: 9711144230" id="callToAction" class="btn btn-light"><i data-feather="phone"></i>Call Fissure Expert Now</a></div>
                          <div class="col-md-6 col-lg-6">
                  ...
                  <div class="show-mobile hide-desktop">
                      <div class="col-md-6 col-lg-6">
                          <a onclick="return gtag_report_conversion('tel:9711144230')" href="tel: 9711144230" id="callToAction" class="btn btn-lg btn-light"><i data-feather="phone"></i>Call Fissure Expert Now</a></div>
                          <div class="col-md-6 col-lg-6">
    ...
    <div id="reviews">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-left">
            <div class="text-left">
                 <h2 style="color: #0F74B2; font-weight: 600;">Glamyo, India’s Favorite Destination for Fissure Treatment</h2>
                </div>
                <div class="testimonials-white">
       ...
       <div class="container show-desktop hide-mobile mt-50">
                  <div class="row">
                      <div class="col-md-6 col-lg-6 text-center">
                          <a onclick="return gtag_report_conversion('tel:9711144230')" href="tel: 9711144230" id="callToAction" class="btn btn-primary"><i data-feather="phone"></i>Call Fissure Expert Now</a>
                  ...
                  <div class="container hide-desktop show-mobile mt-50">
                      ...
                      <div class="col-md-6 col-lg-6 text-center">
                          <a onclick="return gtag_report_conversion('tel:9711144230')" href="tel: 9711144230" id="callToAction" class="btn btn-lg btn-primary"><i data-feather="phone"></i>Call Fissure Expert Now</a>
                                            ...
                                            <div class="card-header" id="faqHeading-1">
                                                <div class="mb-0">
                                                    <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-1" data-aria-expanded="true" data-aria-controls="faqCollapse-1">
                                                        <span class="badge">1</span>How do I know if I have a Fissure?
                                                    </h5>
                                                </div>
                                            </div>
                                            <div id="faqCollapse-1" class="collapse" aria-labelledby="faqHeading-1" data-parent="#accordion">
                                                <div class="card-body">
                                                    <p>If you notice a bulge or swelling near your stomach, abdomen or groin, you may have a Fissure. You should immediately consult a doctor and get diagnosed.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-header" id="faqHeading-2">
                                                <div class="mb-0">
                                                    <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-2" data-aria-expanded="false" data-aria-controls="faqCollapse-2">
                                                        <span class="badge">2</span> What is the best Fissure treatment?
                                                    </h5>
                                                </div>
                                            </div>
                                            <div id="faqCollapse-2" class="collapse" aria-labelledby="faqHeading-2" data-parent="#accordion">
                                                <div class="card-body">
                                                    <p>If your Fissure pains, or if it seems to be continuously growing, the doctor may suggest surgery.
                                                     Most of the Fissure surgeries are done on an outpatient basis. The doctor will make an incision and then he’ll either put the tissue back in position or remove it.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-header" id="faqHeading-3">
                                                <div class="mb-0">
                                                    <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-3" data-aria-expanded="false" data-aria-controls="faqCollapse-3">
                                                        <span class="badge">3</span>Can you live with a Fissure without surgery?
                                                    </h5>
                                                </div>
                                            </div>
                                            <div id="faqCollapse-3" class="collapse" aria-labelledby="faqHeading-3" data-parent="#accordion">
                                                <div class="card-body">
                                                    <p>Fissures don’t go away on their own. Only surgery can repair a Fissure. Some people may never need surgery for a small Fissure.
                                                If the Fissure is small and you don’t have any symptoms, or if the symptoms don’t bother you much, you and your doctor may simply continue to watch for symptoms to occur.</p>
                                            ...
                                            <div class="card-header" id="faqHeading-4">
                                                <div class="mb-0">
                                                    <h5 class="faq-title" data-toggle="collapse" data-target="#faqCollapse-4" data-aria-expanded="false" data-aria-controls="faqCollapse-4">
                                                        <span class="badge">4</span> What can make a Fissure worse?
                                                    </h5>
                                                </div>
                                            </div>
                                            <div id="faqCollapse-4" class="collapse" aria-labelledby="faqHeading-4" data-parent="#accordion">
                                                <div class="card-body">
                                                    <p>A Fissure may, however, be the cause of discomfort and pain, with symptoms often becoming worse when standing, straining, or lifting heavy items.
                                                    In some cases, a Fissure needs immediate surgery, for instance, when part of the gut becomes obstructed or strangulated by an inguinal Fissure.</p>
                                                </div>
                                            </div>
                                        </div>
       ...
       <td colspan='4'  style='text-align:center;font-family:Verdana;font-size:22px; font-weight: 600; word-break: break-word; color:#0F74B2;'>
          ...
          <input class="numeric" type='text' style='width:100%;box-sizing:border-box; border-bottom: 1px solid #999!important; border: none; padding-left: 30px;' required maxlength='10' minlength='10' name='Mobile' required="true"/></td><td style='width:35%;'></td></tr>
              <tr><td  style='word-break: break-word;text-align:left;font-size:15px;font-family:Verdana;width:30%;'>City<span style='color:#222;'>*</span></td><td style='width:40%;'><select class="form-control" style='width:100%;box-sizing:border-box; border-bottom: 1px solid #999!important; border: none; box-shadow: none; text-transform: capitalize'  maxlength='255' name='LEADCF4' required="true"><option value="">Select City</option><option value="Delhi">Delhi</option><option value="Gurgaon">Gurgaon</option><option value="Noida">Noida</option><option value="Faridabad">Faridabad</option><option value="Ghaziabad">Ghaziabad</option><option value="Mumbai">Mumbai</option><option value="Bangalore">Bangalore</option><option value="Hyderabad">Hyderabad</option><option value="Others">Others</option></select></td>
                  <td style='width:30%;'></td></tr><tr style="display: none;"><td style='word-break: break-word;text-align:left;font-size:15px;font-family:Arial;width:30%'>Treatment</td><td style='width:40%;' ><input type='text' style='width:100%;box-sizing:border-box;'  maxlength='255' name='LEADCF1' value='Fissure'></input></td><td style='width:30%;'></td></tr><tr style='display:none;' ><td style='word-break: break-word;text-align:left;font-size:15px;font-family:Arial;width:30%'>Source</td><td style='width:40%;' ><input type='text' style='width:100%;box-sizing:border-box;'  maxlength='255' name='LEADCF3' value='Google'></input></td><td style='width:30%;'></td></tr><tr style='display:none;' ><td style='word-break: break-word;text-align:left;font-size:15px;font-family:Arial;width:30%'>Ad Type</td><td style='width:40%;' ><input type='text' style='width:100%;box-sizing:border-box;'  maxlength='255' name='LEADCF2' value='Website'></input></td><td style='width:30%;'></td></tr><tr style='display:none;' ><td style='word-break: break-word;text-align:left;font-size:15px;font-family:Arial;width:30%'>Lead Status</td><td style='width:40%;'>
