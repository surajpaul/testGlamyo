...
<div class="container-xl">
    ...
    <div class="card-header">
      <h3 class="card-title">Adding Doctor</h3>
    </div>
    <div class="card-body">
        ...
        @csrf
      	<div class="row">
      		...
      		<div class="col-md-3">
		          ...
		          <div >
		            <input id="fee" type="text" class="form-control @error('fee') is-invalid @enderror" name="fee" placeholder="Enter fee" value="{{ old('fee') }}" required autocomplete="fee" autofocus>
	                @error('fee')
	                    <span class="invalid-feedback" role="alert">
	                        <strong>{{ $message }}</strong>
	                    </span>
