...
<div class="container-xl">
    ...
    <div class="card-body">
      <form method="post" action="{{ route('user.ipd.update', $ipd->id ) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
      	<div class="row">
      		<div class="col-md-3">
      		...
      		<div class="col-md-3">
		          ...
		          <div>
		            ...
		            <input type="text" name="aadhar_hide_user" class="d-none" value="{{$ipd->aadhar}}">
	                @error('aadhar')
	                    <span class="invalid-feedback" role="alert">
	                        <strong>{{ $message }}</strong>
	                    </span>
      		...
      		<div class="col-md-6 hide 2 3">
		          ...
		          <label class="form-label">Upload Insurance card :</label>
	                <div>
			            ...
			            <input type="text" class="d-none" name="insurance_hide_user" value="{{$ipd->insurance}}">
		                @error('insurance')
		                    <span class="invalid-feedback" role="alert">
		                        <strong>{{ $message }}</strong>
		                    </span>
